...
def computeMSMS(pdb_file,  protonate=True):
    ...
    vertices, faces, normals, names = read_msms(file_base)  # {vertices xyz coord},shape=(vert_num,3) / {vert1, 2, 3_index}, shape=(face_num,3),{vert_normal xyz vec},shape=(vert_num,3) / res_id,shape=(vert_num,)
    areas = {}
