...
def computeMSMS(pdb_file,  protonate=True):
    ...
    vertices, faces, normals, names = read_msms(file_base)  # {vertices xyz coord},shape=(vert_num,3) / {vert1, 2, 3_index}, shape=(face_num,3),{vert_normal xyz vec},shape=(vert_num,3) / res_id in format (e.g.B_125_x_ASN_ND2_Green),shape=(vert_num,)
    areas = {}
